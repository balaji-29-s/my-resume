...
const Contact = () => {
  const socialLinks = [
    { 
      ...
      url: "https://www.linkedin.com/in/balaji-s-39770232a/",
      color: "hover:text-blue-400"
    },
    { 
      name: "GitHub", 
      icon: <FaGithub className="text-2xl" />, 
      url: "https://github.com/balaji-29-s",
            ...
            <div className="space-y-6">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <a href="mailto:bs8315@srmist.edu.in" className="text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-300 transition-colors duration-300">
                    bs8315@srmist.edu.in
                  </a>
                </div>
              </div>
